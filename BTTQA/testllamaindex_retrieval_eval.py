...
try:
	...
	cache_folder=None
bge_embed_model = HuggingFaceEmbedding(model_name="BAAI/bge-large-en-v1.5" ,cache_folder=cache_folder )

service_context = ServiceContext.from_defaults(llm=azure_lm, embed_model=bge_embed_model )
...
chroma_client = chromadb.PersistentClient(path="paul_graham_eval/Chroma_DB_bge-large")
...
#  load qa_datase json
qa_dataset = EmbeddingQAFinetuneDataset.from_json("paul_graham_eval/pg_eval_dataset2.json")
...
qa_dataset.save_json("paul_graham_eval/pg_eval_dataset2.json")
'''
