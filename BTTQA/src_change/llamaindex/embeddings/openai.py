...
def get_embeddings(
    ...
    print("########### engine :", engine)
    print(f"######### llama_index/embeddings/openai.py  get_embeddings list_of_text ### size:   {len(list_of_text)}   ######### ")
...
def get_engine(
    ...
    """Get engine."""
    print(f"######### llama_index/embeddings/openai.py get_engine input mode:{mode}  model:{model} ")
    if (model=="embedding2"):
        return "embedding2"
...
class OpenAIEmbedding(BaseEmbedding):
    ...
    def _get_query_embedding(self, query: str) -> List[float]:
        ...
        print("######## _get_query_embedding input engine :", self._query_engine)
        
        #if self._query_engine is not "embedding2" :
        #    self._query_engine="embedding2"
        #    print("######## set engine to (Azure) :", self._query_engine)
    ...
    async def _aget_query_embedding(self, query: str) -> List[float]:
        ...
        print("######## _aget_query_embedding input engine :", self._query_engine)
    ...
    def _get_text_embedding(self, text: str) -> List[float]:
        """Get text embedding."""
        client = self._get_client()
        print("######## _get_text_embedding input engine :", self._query_engine)
        return get_embedding(
            client,
            text,
