# site-packages/openai/api_requestor.py
...
class APIRequestor:
    ...
    def request_raw(
        ...
        *,
        ...
        #print("\n\n\n############  site-packages/openai/api_requestor.py   headers : ",headers)
        #print("\n\n\n############  site-packages/openai/api_requestor.py   data : ",data)
    ...
    def _interpret_response_line(
        ...
        # too many response counnts, 
        #print("\n\n############# api_requestor.py , response header :", rheaders)
        #print("f\n\n############# api_requestor.py , response data : {resp.data} \n\n")
