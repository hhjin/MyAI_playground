    ...
    def add_texts(
        ...
        **kwargs: Any,
        ...
        if self._embedding_function is not None:
            ...
            print("\n\n\n################# chroma.py line 158 为Azure ebedding 限制临时改变.......，用后请改回！！！！！ ##########\n\n\n")
            
            #embeddings = self._embedding_function.embed_documents(list(texts))
            
            #''' 
            ######### change start ，需要把上面一行注释掉 ：  # embeddings = self._embedd。。。。。
            ...
            for i, d in enumerate(texts):
                ...
                while embed==None:
                    try:
                        ...
                        if texts[i]>3300:
                            print("\n\n\n############# text length exceeded !!!!! , skip to next: ")
                            texts.pop(i)
                            metadatas.pop(i)
                            continue
                        ...
                        if loopCount>50:
                            print("\n\n\n############# current loopCount exceeded !!!!! , skip to next: ")
                            texts.pop(i)
                            metadatas.pop(i)
                            continue
            ...
            print("\n\n\n############ embeddings finished.   embeddings size: ", len(embeddings) , "   texts size: ", len(texts) , "   metadatas size: ", len(metadatas) )
